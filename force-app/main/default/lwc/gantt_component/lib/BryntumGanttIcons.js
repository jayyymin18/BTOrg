    ...
    if (record.row) {
        if (record.row._allCells.length) {
            if (
                ...
                record.row._allCells[6].innerHTML
            ) {
                ...
                if (record.row._allCells[6].children[0]) {
                    if (
                        record.row._allCells[6].children[0].innerHTML.indexOf(
                            "custom70"
                        ) == -1
                    ) {
                        record.row._allCells[6].children[0].innerHTML =
                            iconElement + record.row._allCells[6].children[0].innerHTML;
                    }
                }
            }
            if (
            ...
            if (
                ...
                if (
                    ...
                    record.row._allCells[6].children[0].classList.contains(
                        "indentCellTrue"
                    ) == false
                ) {
                    if (record.row._allCells[6].children[0]) {
                        record.row._allCells[6].children[0].classList.add(
                            "indentCellTrue"
                        );
                    }
                    if (
