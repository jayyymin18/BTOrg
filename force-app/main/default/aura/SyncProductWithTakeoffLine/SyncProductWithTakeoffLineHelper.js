({
	getQuoteLinesRecords:function(component, event) {
		var action = component.get("c.getTakeoffLineRecordList");
        action.setParams({
            recordId: component.get("v.recordId")
        });
        action.setCallback(this, function (response) {
            if (response.getState() == 'SUCCESS') {
                var takeoffLineList = response.getReturnValue();
                component.set("v.takeoffLineList", takeoffLineList);
	...
	UpdateQuoteLineList: function(component, event, helper){
		var onlyUpdatedTakeoffLines = component.get("v.onlyUpdatedTakeoffLines");
		var onlyUpdatedQuoteLines_JSON = JSON.stringify(onlyUpdatedTakeoffLines);
			component.set("v.ShowMassSaveButton", true);
			var action = component.get("c.massUpdateTakeoffLine");
			action.setParams({
				onlyUpdatedTakeoffLines:  onlyUpdatedQuoteLines_JSON 
			});
			action.setCallback(this, function(response) {
